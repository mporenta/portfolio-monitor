...
import requests
import json
from ib_async import IB, MarketOrder, LimitOrder, PnL, PortfolioItem, AccountValue, Contract, Trade, Stock
...
class IBClient:
    ...
    def on_new_order(self):
        ...
        logging.info(f"def Jengo trade: {trade}")
        return order, trade
    ...
    def on_pnl_update(self, pnl: PnL):
       ...
       for trade in trades:
           self.logger.debug(f"for Jengo trade: {trade}")
    ...
    def check_pnl_conditions(self, pnl: PnL) -> bool:
        ...
        try:
            ...
            if is_threshold_exceeded:
                ...
                self.logger.info("Closing all positions...bitch")
    ...
    def close_all_positions(self):
        ...
        try:
            ...
            for item in portfolio_items:
                ...
                close_postions = self.position != 0
                if close_postions:
                    ...
                    myTrade = self.ib.trades()
                    self.logger.info(f"my trade jengo {myTrade}")
