...
if __name__ == "__main__":
    ...
    if production:
        uvicorn.run("fast_api_app:app", host="0.0.0.0", port=PORT)  # Changed from "main:app"
    else:
        uvicorn.run("fast_api_app:app", host="0.0.0.0", port=PORT, reload=True)  # Changed from "main:app"